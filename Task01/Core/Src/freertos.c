...
void MX_FREERTOS_Init(void) {
  ...
  /* Create the queue(s) */
  /* definition and creation of MsgToMt */
  osMessageQDef(MsgToMt, 16, uint32_t);
  MsgToMtHandle = osMessageCreate(osMessageQ(MsgToMt), NULL);
  ...
  osThreadDef(Msg, taskMsg, osPriorityNormal, 0, 128);
  MsgHandle = osThreadCreate(osThread(Msg), NULL);

  /* definition and creation of Motor */
  osThreadDef(Motor, taskMotor, osPriorityIdle, 0, 128);
...
/* USER CODE BEGIN Header_taskMotor */
/**
* @brief Function implementing the Motor thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_taskMotor */
void taskMotor(void const * argument)
{
